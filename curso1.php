...
<body>
    ...
    <div class="page">
        ...
        <div class="container-fluid p-t-90">
            <div class="row">
                <div class="col-lg-12" style="border: solid 1px;background-image: url(assets/app/img/fondo_2.jpg);margin: 0px;padding-right: 0px;padding-left: 0px;">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="margenvideo">
                                        <iframe class="embed-responsive-item " src="https://www.youtube.com/embed/v8tZ0hh7B5k" width="500px" height="300px" allowfullscreen></iframe>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <p class="titulo-land">ADMINISTRACÍON EN TIEMPOS DE EMERGENCIA</p>
                ...
                <div class="col-lg-3">
                    <div class="position-fixed">
                        <div class="pagador">
                            ...
                            <body><a target="_blank" href="https://www.visanetlink.pe/pagoseguro/IDRACAPACITACIONES/782295"><button style="padding: 10px 16px; line-height: 1.3333333; border-radius: 6px;  -moz-border-radius: 5px;   -webkit-border-radius: 5px; color: #fff;background-color: #0054cb;">COMPRAR</button></a></body>
                            <html>
                        </div>
                    </div>
                </div>
