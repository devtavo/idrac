    ...
    <div class="page">
                        ...
                        <div class="rd-navbar-inner">
                            ...
                            <div class="rd-navbar-panel">
                                ...
                                <div class="rd-navbar-brand">
                                    <a class="brand" href="index.html"><img class="brand-logo-dark" src="images/logo_198_66.png" alt="" width="198" height="66" /></a>
                                </div>
                            </div>
        ...
        <section class="section swiper-container swiper-slider swiper-slider-2 swiper-slider-3" data-loop="true" data-autoplay="5000" data-simulate-touch="false" data-slide-effect="fade">
            <div class="swiper-wrapper text-sm-left">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-9 col-md-8 col-lg-7 col-xl-7 offset-lg-1 offset-xxl-0">
                                    <h1 class="oh swiper-title"><span class="d-inline-block" data-caption-animate="slideInUp" data-caption-delay="0">SIGUENOS EN NUESTRAS
                                            REDES SOCIALES</span></h1>
                ...
                <div class="swiper-slide context-dark" data-slide-bg="images/ban2.jpg">
                    <div class="swiper-slide-caption section-md">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-8 col-lg-12 offset-lg-1 offset-xxl-0">
                                    <h1 class="oh swiper-title" style="text-align: center;padding-top: 0x;"><span class="d-inline-block" data-caption-animate="slideInDown" data-caption-delay="0">#AcreditaTusConocimientos
                ...
                <div class="swiper-slide context-dark" data-slide-bg="images/ban3.jpg">
                    <div class="swiper-slide-caption section-md">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-8 col-lg-12 offset-lg-1 offset-xxl-0">
                                    <h1 class="oh swiper-title" style="color: black;"><span class="d-inline-block" data-caption-animate="slideInDown" data-caption-delay="0">Diplomados y
                                            Cursos de Derecho</span></h1>
                                    <p class="big swiper-text" data-caption-animate="fadeInRight" data-caption-delay="300"> </p>
                                    <div class="button-wrap oh"><a class="button button-lg button-primary button-winona button-shadow-2" href="#" data-caption-animate="slideInUp" data-caption-delay="0">Informes</a></div>
                                </div>
                            </div>
        ...
        <section class="section section-md bg-default">
            <div class="container">
                <h3 class="oh-desktop"><span class="d-inline-block wow slideInDown">Cursos y Diplomados</span></h3>
                <div class="row row-md row-30">
                    <div class="col-sm-6 col-lg-4">
                        <div class="oh-desktop">
                            <!-- Services Terri-->
                            <article class="services-terri wow slideInUp">
                                <div class="services-terri-figure"><img src="images/cur1.jpg" alt="" width="370" height="278" />
                                </div>
                                <div class="services-terri-caption">
                                    <!-- <span class="services-terri-icon linearicons-leaf"></span> -->
                                    <h5 class="services-terri-title"><a href="#">Diplomado 1</a></h5>
                                </div>
                            </article>
                        </div>
                    </div>
                        ...
                        <div class="oh-desktop">
                            ...
                            <article class="services-terri wow slideInDown">
                                ...
                                <div class="services-terri-caption">
                                    ...
                                    <h5 class="services-terri-title"><a href="#">Diplomado 2</a></h5>
                                </div>
                            </article>
                        </div>
                    </div>
                        ...
                        <div class="oh-desktop">
                            ...
                            <article class="services-terri wow slideInUp">
                                ...
                                <div class="services-terri-caption">
                                    ...
                                    <h5 class="services-terri-title"><a href="#">Diplomado 3</a></h5>
                                </div>
                            </article>
                        </div>
                    </div>
                        ...
                        <div class="oh-desktop">
                            ...
                            <article class="services-terri wow slideInDown">
                                ...
                                <div class="services-terri-caption">
                                    ...
                                    <h5 class="services-terri-title"><a href="#">Diplomado 4</a></h5>
                                </div>
                            </article>
                        </div>
                    </div>
                        ...
                        <div class="oh-desktop">
                            ...
                            <article class="services-terri wow slideInUp">
                                ...
                                <div class="services-terri-caption">
                                    ...
                                    <h5 class="services-terri-title"><a href="#">Diplomado 5</a></h5>
                                </div>
                            </article>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <div class="oh-desktop" style="border-radius: 10px;">
                            <!-- Services Terri-->
                            <article class="services-terri wow slideInDown">
                                <div class="services-terri-figure"><img src="images/cur1.jpg" alt="" width="370" height="278" />
                                </div>
                                <div class="services-terri-caption">
                                    ...
                                    <h5 class="services-terri-title"><a href="#">Diplomado 6</a></h5>
                                </div>
                            </article>
                        </div>
                    </div>
        ...
        <!-- Section CTA-->
        <section class="primary-overlay section parallax-container" data-parallax-img="images/sec3.jpg">
                ...
                <div class="row row-lg row-30">
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        ...
                        <article class="product wow fadeInLeft" data-wow-delay=".15s">
                            <div class="product-figure"><img src="images/prom1.jpg" alt="" width="161" height="162" />
                            </div>
                            ...
                            <div class="product-button">
                                ...
                                <!-- <div class="button-wrap"><a class="button button-xs button-secondary button-winona" href="#">Contenido</a></div> -->
                            </div>
                        </article>
                    </div>
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        ...
                        <div class="col-sm-9 col-md-7 col-lg-5">
                            <div class="cta-modern">
                                ...
                                <p class="cta-modern-text cta-modern-text-2 oh-desktop" data-wow-delay=".1s">
                                    ...
                                    <span class="d-inline-block wow slideInUp"><br></span>
                                </p><a class="button button-lg button-secondary button-winona wow fadeInRight" href="https://aula.idra.pe" data-wow-delay=".2s">Acceso al Aula Virtual</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="section section-xl bg-default">
            <div class="container">
                <h3 class="wow fadeInLeft">Contenido Contenido Contenido</h3>
            </div>
                    ...
                    <article class="quote-tara">
                        <div class="quote-tara-caption">
                            <div class="quote-tara-text">
                                <p class="q">Contenido Contenido v Contenido Contenido Contenido</p>
                            </div>
                            <div class="quote-tara-figure"><img src="images/user-6-115x115.jpg" alt="" width="115" height="115" />
                            </div>
                        </div>
                        <h6 class="quote-tara-author">Contenido Contenido Contenido</h6>
                        <div class="quote-tara-status">Contenido Contenido</div>
                    </article>
                    <!-- Quote Tara-->
                    <article class="quote-tara">
                        <div class="quote-tara-caption">
                        ...
                        <div class="quote-tara-status">Contenido Contenido Contenido</div>
                    </article>
                    <!-- Quote Tara-->
                    <article class="quote-tara">
                        <div class="quote-tara-caption">
                            <div class="quote-tara-text">
                                <p class="q">Contenido Contenido Contenido Contenido Contenido</p>
                            </div>
                            <div class="quote-tara-figure"><img src="images/user-7-115x115.jpg" alt="" width="115" height="115" />
                            </div>
                        </div>
                        <h6 class="quote-tara-author">Contenido</h6>
                        <div class="quote-tara-status">Contenido</div>
                    </article>
                    <!-- Quote Tara-->
                    <article class="quote-tara">
                        <div class="quote-tara-caption">
                            <div class="quote-tara-text">
                                <p class="q">Contenido Contenido Contenido Contenido Contenido Contenido.</p>
                            </div>
                ...
                <div class="row row-10 gutters-10 isotope" data-isotope-layout="masonry" data-isotope-group="gallery" data-lightgallery="group">
                    <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                        ...
                        <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInLeft">
                            ...
                            <div class="thumbnail-mary-caption">
                                <div>
                                    <h6 class="thumbnail-mary-title"><a href="#">Contenido</a></h6>
                                    <div class="thumbnail-mary-location">Contenido</div>
                                </div>
                            </div>
                        </article>
                    </div>
                    ...
                    <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                        ...
                        <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInUp">
                            ...
                            <div class="thumbnail-mary-caption">
                                <div>
                                    <h6 class="thumbnail-mary-title"><a href="#">Contenido</a></h6>
                                    <div class="thumbnail-mary-location">SContenido Contenido</div>
                                </div>
                            </div>
                        </article>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                        ...
                        <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInRight">
                            ...
                            <div class="thumbnail-mary-caption">
                                <div>
                                    <h6 class="thumbnail-mary-title"><a href="#">Contenido Contenido</a></h6>
                                    <div class="thumbnail-mary-location">Contenido Contenido</div>
                                </div>
                            </div>
                        </article>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                        ...
                        <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInLeft">
                            ...
                            <div class="thumbnail-mary-caption">
                                <div>
                                    <h6 class="thumbnail-mary-title"><a href="#">Contenido</a></h6>
                                    <div class="thumbnail-mary-location">Contenido Contenido Contenido</div>
                                </div>
                            </div>
                        </article>
                    </div>
        ...
        <section class="section section-sm section-first bg-default">
            <div class="container">
                <h3 class="heading-3"> Contenido Contenido Contenido</h3>
                <form class="rd-form rd-mailform form-style-1" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
                    ...
                    <div class="group-custom-1 group-middle oh-desktop">
                        <button class="button button-lg button-primary button-winona wow fadeInRight" type="submit">Evniar</button>
                        <!-- Quote Classic-->
            ...
            <div class="container">
                <div class="owl-carousel owl-style-11 dots-style-2" data-items="1" data-sm-items="1" data-lg-items="2" data-xl-items="4" data-margin="30" data-dots="true" data-mouse-drag="true" data-rtl="true">
                    <article class="box-icon-megan wow fadeInUp">
                        ...
                        <h5 class="box-icon-megan-title"><a href="#">Contenido Contenido</a></h5>
                        <p class="box-icon-megan-text">Contenido Contenido ContenidoContenidoContenido
                        </p>
                    </article>
                    <article class="box-icon-megan wow fadeInUp" data-wow-delay=".05s">
                        ...
                        <h5 class="box-icon-megan-title"><a href="#">Contenido</a></h5>
                        <p class="box-icon-megan-text">ContenidoContenidoContenidoContenidoContenidoContenidoContenido
                        </p>
                    </article>
                    ...
                    <article class="box-icon-megan wow fadeInUp" data-wow-delay=".15s">
                        ...
                        <h5 class="box-icon-megan-title"><a href="#">Contenido </a></h5>
                        <p class="box-icon-megan-text">Contenido Contenido Contenido Contenido Contenido Contenido Contenido Contenido </p>
                    </article>
                </div>
            </div>
        </section>
                ...
                <div class="container">
                    <div class="row row-50">
                        <div class="col-md-6 col-lg-4">
                            <h5 class="footer-modern-title oh-desktop"><span class="d-inline-block wow slideInLeft">Contenido Contenido </span></h5>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <h5 class="footer-modern-title oh-desktop"><span class="d-inline-block wow slideInLeft">Contenido </span>
                            </h5>
                            <ul class="footer-modern-list d-inline-block d-sm-block wow fadeInUp">
                                <li><a href="about-us.html">Contenido </a></li>
                                <li><a href="#">Contenido </a></li>
                                <li><a href="#">Contenido </a></li>
                                <li><a href="#">Contenido </a></li>
                                <li><a href="#">Contenido </a></li>
                                <li><a href="contacts.html">Contenido </a></li>
                            </ul>
                        </div>
                        <div class="col-lg-4 col-xl-5">
                            <h5 class="footer-modern-title oh-desktop"><span class="d-inline-block wow slideInLeft">Contenido </span>
                            </h5>
                            <p class="wow fadeInRight">Contenido Contenido Contenido Contenido Contenido Contenido </p>
                            <!-- RD Mailform-->
                            <form class="rd-form rd-mailform rd-form-inline rd-form-inline-sm oh-desktop" data-form-output="form-output-global" data-form-type="subscribe" method="post" action="bat/rd-mailform.php">
                                <div class="form-wrap wow slideInUp">
                                    ...
                                    <label class="form-label" for="subscribe-form-2-email">Contenido </label>
                                </div>
                                <div class="form-button form-button-2 wow slideInRight">
                                    <button class="button button-sm button-icon-3 button-primary button-winona" type="submit"><span class="d-none d-xl-inline-block">Contenido </span><span
                        ...
                        <div class="col-sm-6 col-md-7 col-lg-4 col-xl-4">
                            <div class="row row-30 align-items-center text-lg-center">
                                <div class="col-md-7 col-xl-6">
                                    <a class="brand" href="index.html"><img src="images/logo-inverse-19.png" alt="" width="198" height="66" /></a>
                                </div>
                            ...
                            <div class="group-xmd group-sm-justify">
                                <div class="footer-modern-contacts wow slideInUp">
                                    <div class="unit unit-spacing-sm align-items-center">
                                        ...
                                        <div class="unit-body"><a class="phone" href="tel:#">+51 999 999 999</a></div>
                                    </div>
                                </div>
                                <div class="footer-modern-contacts wow slideInDown">
                                    <div class="unit unit-spacing-sm align-items-center">
                                        <div class="unit-left"><span class="icon mdi mdi-email"></span></div>
                                        <div class="unit-body"><a class="mail" href="mailto:#">Contenido @idra.pe</a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="footer-modern-line-3">
                <div class="container">
                    <div class="row row-10 justify-content-between">
                        <div class="col-md-6"><span>Contenido Contenido Contenido Contenido Contenido Contenido </span>
                        </div>
                        <div class="col-md-auto">
                            <!-- Rights-->
                            <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span><span></span><span>.&nbsp;</span><span>All Rights
                                    Reserved.</span><span>
                                    Diseñado&nbsp;por&nbsp;<a href="#">Gustavo Reyes</a></span></p>
                        </div>
                    </div>
                </div>
            </div>
