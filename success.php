...
// $_GET['id']
    $vari = $_GET['id'];
    $vare = base64_decode($vari);
    
    // header('Location: https://idra.pe');
// }
...
<body>
    ...
    <div class="page">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <h5>Felicitaciones, ya perteneces a la comunidad IDRA</h5>
                    <p>Sigue los siguientes pasos, para terminar el proceso:</p>
                    <ul>
                        <li>Comunicate con uno de nuestros asesores</li>
                        <li>indicando el número de orden:  <? echo $vare ?>  </li>
                        <li><button class="what" onclick="window.open('https://api.whatsapp.com/send?phone=51942321318&text=Orden%20de%20compra%20%20<?php echo $vare; ?>', '_blank');"><i class="fa fa-whatsapp"></i> Chat WhatsApp</button></li>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="images/aula2.png" width="320px" height="120px" alt="Card image cap">
                        <div class="card-body">
                            <a href="#" target="" class="btn btn-block text-uppercase" id="dip" name="dip" style="background-color:#004396;">Acceso Aula virtual</a>
                        </div>
                    </div>
                </div>
